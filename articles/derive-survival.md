...
#>   outcome_followup_years: mean=11.84, median=12.31, range=[0.00, 14.92]
```
...
# Incident analysis: exclude participants with prevalent disease at baseline
df_incident <- df[outcome_timing != 1L | is.na(outcome_timing)]
