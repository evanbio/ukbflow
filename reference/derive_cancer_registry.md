...
#> ! derive_cancer_registry (skin): 0 cases after filtering.
derive_cancer_registry(dt, name = "invasive", icd10 = "^C", behaviour = 3L)
#> ✔ derive_cancer_registry (invasive): 4 cases, 4 with date.
...
#>      p40002_i0_a1 p40002_i0_a2  p40000_i0    p131742   grs_bmi    grs_raw
#>            <char>       <char>     <char>     <char>     <num>      <num>
#>      grs_finngen messy_allna messy_empty messy_label skin_cancer
...
#>  68:    0.190296        <NA>        <NA>     unknown       FALSE
...
#>  85:    1.252130        <NA>        <NA>        NULL       FALSE
#>  86:   -1.083332        <NA>        <NA>        <NA>       FALSE
#>  87:    2.833747        <NA>        <NA>          -1       FALSE
#>  88:   -2.505783        <NA>        <NA>        <NA>       FALSE
#>  89:    1.393036        <NA>        <NA>           .       FALSE
...
#>  97:   -2.087084        <NA>                    <NA>       FALSE
#>  98:   -0.099431        <NA>        <NA>        <NA>       FALSE
#>  99:    0.722020        <NA>        <NA>        <NA>       FALSE
#> 100:   -3.848476        <NA>        <NA>          -1       FALSE
#>      grs_finngen messy_allna messy_empty messy_label skin_cancer
#>            <num>      <char>      <char>      <char>      <lgcl>
#>      skin_cancer_date invasive_cancer invasive_cancer_date
#>                <IDat>          <lgcl>               <IDat>
#>   1:             <NA>           FALSE                 <NA>
#>   2:             <NA>           FALSE                 <NA>
#>   3:             <NA>           FALSE                 <NA>
