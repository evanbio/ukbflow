...
#> ── Numeric ──────────────────────────────────────────────────────────────────
#>   body_mass_index_bmi_i0: mean=27.4, median=26.8, sd=4.9,
#>   Q1=24.1, Q3=30.1, NA=0.9% (n=4 512)
#> ── Factor ───────────────────────────────────────────────────────────────────
#>   sex [2 levels]
...
#> ✔ derive_selfreport (disease): 8 104 cases across 4 visit instances.
#>   disease_selfreport: TRUE=8 104, FALSE=493 993
#>   disease_selfreport_date: 8 104 with date
...
#> ✔ derive_first_occurrence (disease): 12 043 cases.
#>   disease_fo: TRUE=12 043, FALSE=490 054
#>   disease_fo_date: 12 043 with date
```
...
#> ✔ derive_death_registry (disease): 312 cases.
#>   disease_death: TRUE=312, FALSE=501 785
#>   disease_death_date: 312 with date
```
