...
plot_tableone(df, vars = c("age_at_recruitment", "sex", "bmi"),
              strata = "outcome_status", save = TRUE, dest = "results/table1")
```
...
> UK Biobank holds data on half a million people. `ukbflow` exists to make
> that data accessible — cleanly, reproducibly, and without leaving the cloud.
