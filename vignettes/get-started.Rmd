...
| Audit | `audit_start()`, `audit_snapshot()`, `audit_job()`, `audit_write()` | `vignette("audit")` |
...
`vignette("smoking_lung_cancer")` — **Smoking and Lung Cancer Risk: A Synthetic Workflow Demonstration**
